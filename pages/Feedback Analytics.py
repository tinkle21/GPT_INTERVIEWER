...
if st.session_state.display_analytics:
    if st.session_state.feedback_response is None:
        with st.spinner("processing"):
            feedback_response=get_feedback_analytics(feedback_analytics,st.session_state.messages,st.session_state.open_api_key)
...
if  st.session_state.feedback_response:
    ...
    if st.button("Generate more Feedback"):
        feedback_response=get_feedback(st.session_state.messages,"please provide feedback of my interview process",st.session_state.open_api_key)
        if feedback_response:
            st.download_button(label="Download Interview Feedback", data=feedback_response.content, file_name="interview_feedback.txt")
...
if not st.session_state.display_analytics:
    ...
    st.markdown("#### Select Technical Interview Screen From Side Bar to start your interview!")
    st.markdown("#### After the Interview You can see your Analytics here!Thank you")